...
/**
 * Brand icons rendered inline because lucide-react no longer ships brand logos.
 * Stroke-based to visually match the rest of the lucide icon set.
 */
...
function base({ size = 16, ...rest }: BrandIconProps) {
  return {
    width: size,
    height: size,
    viewBox: "0 0 24 24",
